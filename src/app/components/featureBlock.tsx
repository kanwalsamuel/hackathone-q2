...
//   },
//   {
//     icon: <FaRegCheckCircle className="text-2xl text-gray-700" />,
...
//   },
//   {
//     icon: <FaSeedling className="text-2xl text-gray-700" />,
...
//   return (
//     <section
//       className="w-full max-w-[1440px] bg-white py-10 px-6 mx-auto"
//     >
//       <h3 className="text-center text-[34px] font-bold text-[#2A254B] mb-10">
...
//               {feature.icon}
//             </div>
//             <h4 className="text-[20px] font-[Clash Display] font-medium text-[#2A254B]">
//               {feature.title}
//             </h4>
//             <p className="text-[16px] font-[Satoshi] text-gray-600">
//               {feature.description}
//             </p>
//           </div>
//         ))}
...
//   },
//   {
//     icon: <FaRegCheckCircle className="text-3xl md:text-4xl text-gray-700" />,
//     title: "Made by true artisans",
//     description: "Handmade crafted goods made with real passion and craftsmanship.",
//   },
//   {
//     icon: <FaLaptop className="text-3xl md:text-4xl text-gray-700" />,
//     title: "Unbreakable prices",
//     description: "For our material and quality you won’t find better prices anywhere.",
//   },
//   {
//     icon: <FaSeedling className="text-3xl md:text-4xl text-gray-700" />,
//     title: "Recycled packaging",
//     description: "We use 100% recycled packaging to ensure our footprint is manageable.",
//   },
// ];
...
//       <h3 className="text-center text-[28px] sm:text-[34px] font-bold text-[#2A254B] mb-10">
//         What makes our brand different
//       </h3>
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
//         {features.map((feature, index) => (
...
//               {feature.icon}
//             </div>
//             <h4 className="text-[18px] sm:text-[20px] font-[Clash Display] font-medium text-[#2A254B]">
//               {feature.title}
//             </h4>
//             <p className="text-[14px] sm:text-[16px] font-[Satoshi] text-gray-600">
//               {feature.description}
//             </p>
//           </div>
//         ))}
