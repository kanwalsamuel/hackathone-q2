...
//     <div className="min-h-screen bg-gray-50 flex justify-center items-center W-[1440px] h-[749px]">
//       <div className="max-w-6xl w-full px-4">
//         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
//           {/* Left Section */}
//           <div className="lg:col-span-2  text-[#2A254B]shadow-lg rounded-lg p-6">
//             <h1 className="text-2xl font-semibold mb-6 text-[#2A254B]" >Your Shopping Cart </h1>
...
//                     <p className="text-[#2A254B] text-sm">A sleek wooden vase</p>
//                   </div>
//                 </div>
//                 <p className="font-semibold text-[#2A254B]">£85</p>
//               </div>
...
//                 <span>Subtotal</span>
//                 <span className="font-semibold text-[#2A254B]">£170</span>
//               </div>
//               <div className="flex justify-between text-[#2A254B]">
//                 <span>Shipping</span>
//                 <span className="font-semibold text-[#2A254B]">£40</span>
//               </div>
//             </div>
...
//               <span>£210</span>
//             </div>
//             <button className="w-full mt-6 bg-blue-600 text-white py-3 rounded-lg text-center font-medium hover:bg-blue-700">
//               Go to Checkout
//             </button>
//           </div>
//         </div>
