...
//       image,
//       slug,
//       category->{title}  // Fetch the category title for each product
//     }
//   }`;
...
//             Home
//           </Link>
//           <Link href="/about" className="text-white mx-4">
//             About
//           </Link>
//           <Link href="/contact" className="text-white mx-4">
//             Contact
//           </Link>
//           <Link href="/products" className="text-white mx-4">
//             Products
//           </Link>
//         </div>
//       </div>
...
//         <h1 className="text-4xl font-bold mb-6 text-[#2a254b]">
...
//                 </p>
//               </div>
//               {/* Display Current Product / Total Products */}

//               {/* Display Category Name */}

//               {/* Product Number (Top Right Corner) */}
