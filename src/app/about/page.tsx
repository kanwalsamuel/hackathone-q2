    ...
    <div className="w-full bg-white flex flex-col mx-auto relative">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between sm:px-8 py-6">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex space-x-6 items-center text-[16px] sm:text-[20px] sm:ml-16 sm:space-x-8">
            <Link
              href="/"
              className="text-[#726E8D] font-satoshi leading-[22px] text-center sm:text-left "
            >
              About Us
            </Link>
            <Link
            ...
            <Link
              href="/"
              className="text-[#726E8D] font-satoshi text-center sm:text-left"
            >
              Blog
            </Link>
          </div>
      ...
      {/* Custom Section */}
      <div className="w-full bg-[#2A254B] flex flex-col sm:flex-row items-center justify-between px-8 py-8 sm:h-[277px] mt-6">
